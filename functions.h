...
/* Alard.c */
void        getKernelVec();
int         fillStamp(stamp_struct *, double *, double *, double *, float *, float *, float *,int *,int *, int);
...
void        fitKernel(stamp_struct *, double *,  double *, double *, float *, float *, float *, float *, double *, double *, double *, int *);
/*void        build_matrix0(stamp_struct *);
void        build_scprod0(stamp_struct *, float *);*/
double      check_stamps(stamp_struct *, double *, double *,double *, int, float *, float *);
...
void        spatial_convolve(float *, float *, float**, int, int, double **, float *, int *);
...
/* Functions.c */
int         allocateStamps(stamp_struct *, double **, double **,double **,double **,int);
...
void        freeStampMem(stamp_struct *,  double *, double * , double *, int);
...
/* mysinc.c */
int         swarp_remap(float *, float *, double, double, int, int, int, float *, float *, int);
...
/*GPU*/
void		startgpu();
void        cuda_init(float *, float *, float **, float **);
void        cuda_finish(float *, float *, double *, double *);
